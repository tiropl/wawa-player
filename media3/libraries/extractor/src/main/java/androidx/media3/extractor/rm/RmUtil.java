...
final class RmUtil {
  ...
  /**
   * Number of PCM samples per codec frame for RealAudio codecs that use 1024-sample windows (Cook,
   * ATRAC, raac/racp AAC).
   */
  ...
  static void emitSample(
      TrackOutput output, ParsableByteArray data, int size, long timestampUs, boolean isKeyFrame) {
