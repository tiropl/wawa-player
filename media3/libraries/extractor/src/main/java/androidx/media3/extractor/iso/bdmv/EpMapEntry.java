...
public final class EpMapEntry {
  ...
  /**
   * Whether this entry marks a point where the angle changes (is_angle_change_point bit in the fine
   * EP entry). When true, the entry is an angle change point for multi-angle clips.
   */
