...
public final class AdtsReader implements ElementaryStreamReader {
  ...
  private static AacPce parseAacProgramConfigElement(ParsableBitArray input)
  ...
  private static int copyBits(ParsableBitArray input, ParsableBitArray output, int bitCount)
      throws ParserException {
    int value = 0;
