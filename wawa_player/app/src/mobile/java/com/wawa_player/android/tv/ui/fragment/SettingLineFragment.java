...
import com.wawa_player.android.tv.databinding.FragmentSettingLineBinding;
...
public class SettingLineFragment extends BaseFragment implements ConfigListener, SiteListener, LiveListener, DanmakuListener {

    private FragmentSettingLineBinding mBinding;

    public static SettingLineFragment newInstance() {
        return new SettingLineFragment();
    }

    @Override
    protected ViewBinding getBinding(@NonNull LayoutInflater inflater, @Nullable ViewGroup container) {
        return mBinding = FragmentSettingLineBinding.inflate(inflater, container, false);
    }
