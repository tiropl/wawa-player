...
import com.wawa_player.android.tv.api.SiteApi;
...
import com.wawa_player.android.tv.bean.Keep;
...
import com.wawa_player.android.tv.event.CastEvent;
import com.wawa_player.android.tv.event.RefreshEvent;
import com.wawa_player.android.tv.impl.CustomTarget;
import com.wawa_player.android.tv.model.VideoViewModel;
import com.wawa_player.android.tv.playback.PlaybackAction;
import com.wawa_player.android.tv.playback.PlaybackIntent;
import com.wawa_player.android.tv.playback.PlaybackOrientation;
import com.wawa_player.android.tv.playback.PlaybackReset;
import com.wawa_player.android.tv.playback.PlaybackResult;
import com.wawa_player.android.tv.playback.vod.VodDetailResult;
import com.wawa_player.android.tv.playback.vod.VodPlayRequest;
import com.wawa_player.android.tv.playback.vod.VodPlaybackController;
import com.wawa_player.android.tv.playback.vod.VodPlaybackHost;
...
import com.wawa_player.android.tv.ui.adapter.FlagAdapter;
import com.wawa_player.android.tv.ui.adapter.QualityAdapter;
import com.wawa_player.android.tv.ui.adapter.QuickAdapter;
import com.wawa_player.android.tv.ui.base.ViewType;
import com.wawa_player.android.tv.ui.custom.CustomKeyDown;
...
import com.wawa_player.android.tv.ui.dialog.CastDialog;
...
import com.wawa_player.android.tv.ui.dialog.EpisodeGridDialog;
import com.wawa_player.android.tv.ui.dialog.EpisodeListDialog;
import com.wawa_player.android.tv.ui.dialog.InfoDialog;
import com.wawa_player.android.tv.ui.dialog.ParseDialog;
import com.wawa_player.android.tv.ui.dialog.PlayerEngineDialog;
import com.wawa_player.android.tv.ui.dialog.ReceiveDialog;
import com.wawa_player.android.tv.ui.dialog.SpeedSettingDialog;
...
public class VideoActivity extends PlaybackActivity implements Clock.Callback, CustomKeyDown.Listener, ControlDialog.Listener, ParseDialog.Listener, VodPlaybackHost, FlagAdapter.OnClickListener, EpisodeAdapter.OnClickListener, QualityAdapter.OnClickListener, QuickAdapter.OnClickListener, CastDialog.Listener, InfoDialog.Listener {
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        if (isPort()) {
            mFrameParams.height = ResUtil.getScreenHeight() * 3 / 10;
    ...
    protected void initEvent() {
        ...
        mBinding.control.action.danmaku.setOnClickListener(view -> onDanmakuShow());
    ...
    private void updateElderModeUI() {
        ...
        if (elder) {
            ...
            if (service() != null) {
                PlaybackAction.setTracks(player(), mBinding.control.action.text, null, mBinding.control.action.video);
            }
        }
    }
    ...
    private void showControl() {
        ...
        mBinding.control.danmaku.setVisibility(lock || fs ? View.GONE : View.VISIBLE);
        mBinding.control.action.danmaku.setVisibility(fs && !lock ? View.VISIBLE : View.GONE);
        ...
        mBinding.control.play.setVisibility(fs ? View.GONE : View.VISIBLE);
        mBinding.control.fullscreen.setVisibility(fs ? View.GONE : View.VISIBLE);
        mBinding.control.bottom.setVisibility(lock ? View.GONE : View.VISIBLE);
        mBinding.control.back.setVisibility(lock ? View.GONE : View.VISIBLE);
    ...
    private void checkDanmakuImg() {
        int res = DanmakuSetting.isShow() ? R.drawable.ic_control_danmaku_on : R.drawable.ic_control_danmaku_off;
        mBinding.control.danmaku.setImageResource(res);
        mBinding.control.action.danmaku.setImageResource(res);
    }
