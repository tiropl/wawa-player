...
public class LockActionAdapter extends RecyclerView.Adapter<LockActionAdapter.ViewHolder> {
    ...
    public LockActionAdapter(OnClickListener listener) {
        this.listener = listener;
        this.mItems = new String[]{
                ResUtil.getString(R.string.lock_action_change),
                ResUtil.getString(R.string.lock_action_clear)
        };
    }
